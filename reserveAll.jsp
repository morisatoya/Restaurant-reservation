...
<body>
	...
	<table>
		...
		<%
			ArrayList<Reserve> al = (ArrayList<Reserve>)(request.getAttribute("reserveListAll"));
			if(al == null){
		...
		<tr>
			...
			<form action="ReserveUpdateSvl" method="post">
				...
				<input type="hidden" name="usrId" value="<%= r.getUsrId() %>"/></td>
		...
		<tr>
			<td colspan="10" id="boder" class="panel bw">
				<form action="ReserveInsertSvl" method="post">
					<input Type="text" id = "usrId"></input><button>新規ご予約</button>
				</form>
			</td>
		</tr>
	</table>
	<p id="boder"><a href="adminIndex.jsp">管理者メニューに戻る</a></p>
	</div>
	</div>
</body>
</html>